    ...
    return (
        <Link href={`/products/${product.id}`} passHref>
            <motion.div
                ...
                whileTap={{ scale: 0.95 }}
            >
                <div className="absolute top-0 right-0 bg-white p-1 rounded-full shadow-md z-10 border-2 border-transparent hover:border-slate-500 opacity-0 group-hover:opacity-100 transition-opacity transition-colors duration-200">
